...
/**
 * Event subscriber for 'entity_view_display_edit_form' form alter.
 */
class FormEntityViewDisplayEditAlterEventSubscriber implements EventSubscriberInterface {
  ...
  /**
   * Alter the entity view edit form third-party elements structure.
   *
   * This works around the problem that Drupal core nests each invokation of
   * 'field_formatter_third_party_settings_form' under the machine name of the
   ...
   *
   * @see \Drupal\field_event_dispatcher\Event\Field\FieldFormatterThirdPartySettingsFormEvent::addElements()
