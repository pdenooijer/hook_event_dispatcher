...
/**
 * Event subscriber for 'entity_form_display_edit_form' form alter.
 */
class FormEntityFormDisplayEditAlterEventSubscriber implements EventSubscriberInterface {
  ...
  /**
   * Alter the entity form-display edit form third-party elements structure.
   *
   * This works around the problem that Drupal core nests each invokation of
   * 'field_event_dispatcher_field_widget_third_party_settings_form' under the
   * machine name of the module that implements it, which would be the name of
   * this module and not the modules that subscribe to our event.
   *
   ...
   *   'field_event_dispatcher_field_widget_third_party_settings_form' under the
   *   machine name of the module that implements it.
   *
   * @see \Drupal\field_event_dispatcher\Event\Field\FieldWidgetThirdPartySettingsFormEvent::addElements()
