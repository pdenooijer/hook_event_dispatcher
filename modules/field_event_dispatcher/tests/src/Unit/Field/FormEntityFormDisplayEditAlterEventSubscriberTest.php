...
use Drupal\field_event_dispatcher\EventSubscriber\Form\FormEntityFormDisplayEditAlterEventSubscriber;
 ...
 */
class FormEntityFormDisplayEditAlterEventSubscriberTest extends UnitTestCase {
   ...
   * @var string
   */
  private $formId = 'entity_form_display_edit_form';
   ...
   *   FormEntityFormDisplayEditAlterEventSubscriber for it to alter.
   * @param array &$expectedForm
   *   This is a duplicate of $form that is altered here in this method to match
   *   the expected changes FormEntityFormDisplayEditAlterEventSubscriber
   *   performs on $form.
   *
   * @see \Drupal\field_event_dispatcher\EventSubscriber\Form\FormEntityFormDisplayEditAlterEventSubscriber::formAlter()
   */
  private function alterForm(array &$form, array &$expectedForm): void {
    $eventSubscriber = new FormEntityFormDisplayEditAlterEventSubscriber();
  ...
  /**
   * FormEntityFormDisplayEditAlterEventSubscriber test with no fields.
   *
   * This tests that FormEntityFormDisplayEditAlterEventSubscriber::formAlter()
  ...
  /**
   * FormEntityFormDisplayEditAlterEventSubscriber test with one field.
   *
   * This tests that FormEntityFormDisplayEditAlterEventSubscriber::formAlter()
  ...
  /**
   * FormEntityFormDisplayEditAlterEventSubscriber test with two fields.
   *
   * This tests that FormEntityFormDisplayEditAlterEventSubscriber::formAlter()
  ...
  /**
   * FormEntityFormDisplayEditAlterEventSubscriber test with multiple merges.
   *
   * This tests that FormEntityFormDisplayEditAlterEventSubscriber::formAlter()
